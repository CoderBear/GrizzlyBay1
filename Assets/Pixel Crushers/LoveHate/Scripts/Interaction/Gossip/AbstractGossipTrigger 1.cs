...
namespace PixelCrushers.LoveHate 
{
	...
	public abstract class AbstractGossipTrigger : AbstractTriggerInteractor 
	{
		...
		public void TryGossip(FactionMember other) 
		{
		...
		private bool ShouldGossip(FactionMember other) 
		{
			...
			var tooRecent = lastGossip.ContainsKey(other) && (Time.time < (lastGossip[other] + timeBetweenGossip));
			return !tooRecent && (m_self.GetAffinity(other) > 0);
		}

		private void Gossip(FactionMember other) 
		{
